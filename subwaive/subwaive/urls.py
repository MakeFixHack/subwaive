"""
URL configuration for subwaive project.
...
urlpatterns = [
    ...
    path('person/<int:person_id>/check-in/', views.member_check_in, name='member_check_in'),
    path('person/<int:person_id>/check-in/force/', views.force_member_check_in, name='force_member_check_in'),
    ...
    path('person/<int:person_id>/name/<int:important_field_id>/', views.set_name, name='set_name'),
