    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_renew', models.DateTimeField(blank=True, null=True)),
                ...
                ('product', models.ForeignKey(help_text='What Stripe Customer holds this Subscription?', on_delete=django.db.models.deletion.CASCADE, to='subwaive.stripeproduct')),
            ],
        ),
    ]
